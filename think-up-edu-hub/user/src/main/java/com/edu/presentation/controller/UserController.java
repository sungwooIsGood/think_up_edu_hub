...
public class UserController {
    ...
    public BasicResponse resetRefreshToken(HttpServletRequest request, HttpServletResponse response){
    ...
    public BasicResponse verifyLogin(HttpServletRequest request,HttpServletResponse response){
